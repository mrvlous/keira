...
*   [Task Scheduler](architecture/scheduler.md): Preemptive priority multitasking model, scheduler queue, context switching, and Unix signals (`sys_kill`).
*   [System Calls and Interrupts](architecture/syscalls.md): Exception handling, 22 system call vectors, Local APIC controller, and privilege level transitions.
...
*   [Intel e1000 Network Driver](drivers/network.md): PCI enumeration, MAC address parsing, TCP state engine, DHCP client, UDP 53 DNS Resolver, and Dynamic ARP cache.
