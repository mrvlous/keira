...
*   **70 System Call Vectors** (`sys_print_char` .. `sys_sched_autogroup`).
*   **79 Native Kernel Shell Commands** (`guide` .. `autogroup`).
*   **43 Dedicated Modular Documentation Files** in `docs/`.
