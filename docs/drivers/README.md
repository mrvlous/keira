...
* [Intel High Definition Audio (HDA) DSP & WAV Streaming Engine](audio_dsp.md): Audio DMA stream ring buffers, RIFF WAV header parsing, and master volume control (`sys_audio_dsp`).
...
* [USB 3.0 xHCI Isochronous Driver](xhci.md): High-speed USB 3.0 xHCI isochronous transfer ring buffers (`sys_xhci_iso`).
