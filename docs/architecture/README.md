...
* [System Calls & Interrupts](syscalls.md): 76 system call vectors, Local APIC controller, dynamic TSS RSP0 stack switching.
...
* [POSIX Sched_Deadline EDF Scheduler](deadline.md): Hard real-time Earliest Deadline First scheduler (`sys_sched_setattr`).
* [POSIX Sched_Autogroup Task Isolation](autogroup.md): Per-TTY terminal session autogrouping (`sys_sched_autogroup`).
* [Kernel Page Table Isolation (KPTI / KASI)](kpti.md): Ring 0 / Ring 3 page table isolation (`sys_kpti`).
