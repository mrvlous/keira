...
//! Continuous TCP connection stream handling, buffer management, and chunk decoding.
...
use crate::tcp::header::{tcp_checksum, TCP_FLAG_FIN, TCP_FLAG_RST};
use crate::tcp::state::get_next_src_port;
...
///
/// # Safety
/// Transmits and receives raw Ethernet frames using e1000 DMA engine.
...
///
/// # Safety
/// Directly manipulates static `STREAM_DOWNLOAD_BUFFER` and raw packet queues.
