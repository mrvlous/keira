...
//! Intel 82540EM (e1000) device driver and packet transmission/reception.

use keira_io::bus::pci;
use keira_mem::vmm;

use super::regs::{E1000RxDesc, E1000TxDesc, RxRing, TxRing};
...
///
/// # Safety
/// Manipulates physical PCI memory regions and volatile hardware registers.
...
///
/// # Safety
/// Writes packet bytes into DMA transmit ring and updates MMIO register.
...
///
/// # Safety
/// Reads received DMA ring descriptors and memory buffers.
