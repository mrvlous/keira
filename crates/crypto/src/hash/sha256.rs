...
impl Sha256 {
    /// Create a new empty SHA-256 state machine.
    ...
    /// Update hash state with additional byte slice.
    ...
    /// Finalize hash and produce 32-byte SHA-256 digest.
...
/// Compute SHA-256 digest of input data in a single pass.
