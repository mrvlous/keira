...
pub use pool::{
    ...
    heap_get_free, heap_get_peak, heap_get_total, heap_get_used, heap_init, kfree, kmalloc,
    BlockHeader, BLOCK_MAGIC, HEADER_SIZE, HEAP_ALIGNMENT, HEAP_ALIGN_MASK, LARGE_CLASS,
