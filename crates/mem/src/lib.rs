...
pub use vmm::{
    ...
    free_and_unmap_page, free_user_pages, get_kaslr_offset, get_phys_addr, get_pte_in_pml4,
    is_page_mapped_in_pml4, madvise_pages, map_page, mmap_anonymous, mprotect_pages, munmap_pages,
    switch_address_space, sys_mmap, sys_mprotect, sys_munmap, unmap_page, validate_virt_addr_range,
    verify_vma_pte_invariants, GB_1_IDENTITY_MAP, PAGE_HUGE, PAGE_NO_EXECUTE, PAGE_PRESENT,
    PAGE_USER, PAGE_WRITABLE, PTE_ADDR_MASK, USER_MAX_VADDR, USER_MIN_VADDR,
};
