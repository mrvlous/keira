...
//! PS/2 Auxiliary Mouse Controller hardware driver and IRQ12 packet state machine.

use super::packet::{
    MOUSE_CMD_ENABLE_STREAM, MOUSE_CMD_SET_DEFAULTS, MOUSE_FLAGS_SYNC, MOUSE_FLAGS_X_OVERFLOW,
    MOUSE_FLAGS_Y_OVERFLOW, MOUSE_IRQ, PS2_CMD_ENABLE_MOUSE, PS2_CMD_READ_CONFIG,
    PS2_CMD_WRITE_CONFIG, PS2_CMD_WRITE_MOUSE, PS2_STATUS_INPUT_FULL, PS2_STATUS_MOUSE_DATA,
...
/// I/O port address for PS/2 data register.
pub const PS2_DATA_PORT: u16 = 0x60;

/// I/O port address for PS/2 status register.
pub const PS2_STATUS_PORT: u16 = 0x64;

/// I/O port address for PS/2 command register.
pub const PS2_COMMAND_PORT: u16 = 0x64;

static mut MOUSE_CYCLE: u8 = 0;
static mut MOUSE_BYTE: [i8; 3] = [0; 3];

/// Current integer horizontal screen pixel/cell coordinate of mouse.
pub static mut MOUSE_X: i32 = 40;

/// Current integer vertical screen pixel/cell coordinate of mouse.
pub static mut MOUSE_Y: i32 = 12;

static mut MOUSE_FX: i32 = 40 * 256;
static mut MOUSE_FY: i32 = 12 * 256;

/// Maximum horizontal boundary for mouse clipping.
pub static mut MOUSE_MAX_X: i32 = 80;

/// Maximum vertical boundary for mouse clipping.
pub static mut MOUSE_MAX_Y: i32 = 25;

/// Horizontal sensitivity scaling divisor.
pub static mut MOUSE_SENSITIVITY_X: i32 = 24;

/// Vertical sensitivity scaling divisor.
pub static mut MOUSE_SENSITIVITY_Y: i32 = 12;

/// Sets coordinate boundaries and sensitivity scaling factors based on screen resolution.
...
/// Initializes PS/2 auxiliary mouse controller and unmasks IRQ12.
pub fn init() {
    mouse_wait(1);
    unsafe {
...
/// Foreign function export for mouse resolution changes.
#[no_mangle]
