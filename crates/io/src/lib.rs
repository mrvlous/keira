...
pub use self::storage::ahci::{
    self, flush_dma_cache, init as ahci_init, AhciBlockDevice, AHCI_DEVICE,
};
...
pub use self::vga::color::Color as VgaColor;
pub use self::vga::console::{
