...
//! Advanced Configuration and Power Interface (ACPI) table parsing and discovery.
//!
//! Provides descriptors for the Root System Description Pointer (RSDP), System
//! Description Tables (SDT), Multiple APIC Description Table (MADT), and topology
//! probing across system physical memory.
...
/// ACPI 1.0 and 2.0+ Root System Description Pointer (RSDP) binary descriptor.
