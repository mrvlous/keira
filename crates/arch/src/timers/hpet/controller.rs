...
//! High-Precision Event Timer (HPET) MMIO hardware driver.
//!
...
pub struct HpetInfo {
    ...
    pub is_64bit: bool,
    /// True if 8254 and RTC replacement interrupt routing is supported.
...
pub(crate) static mut HPET_INFO: Option<HpetInfo> = None;
pub(crate) static mut HPET_PERIOD_FS: u32 = 0;
pub(crate) static mut HPET_START_TICKS: u64 = 0;

#[cfg(not(target_os = "none"))]
pub(crate) static mut MOCK_HPET_MEM: [u8; 1024] = [0u8; 1024];
#[cfg(not(target_os = "none"))]
pub(crate) static mut MOCK_SIMULATED_COUNTER: u64 = 1_000;
...
#[cfg(not(target_os = "none"))]
pub(crate) unsafe fn read_reg64(offset: usize) -> u64 {
...
#[cfg(not(target_os = "none"))]
pub(crate) unsafe fn write_reg64(offset: usize, val: u64) {
    if offset == HPET_REG_MAIN_CNT {
