...
//! 8254 Programmable Interval Timer (PIT) port definitions and tick handling.
...
/// Initialize PIT timer to standard operating frequency.
...
/// C ABI compatible export for system uptime queries.
#[no_mangle]
