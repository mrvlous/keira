...
//! x86/x86_64 Interrupt Descriptor Table (IDT) gate structures and table initialization.
//!
...
/// Sets a single gate descriptor in the IDT.
...
/// Initializes the 256-entry IDT and loads it into the CPU IDTR register.
pub fn init() {
    unsafe {
...
/// Loads the global Interrupt Descriptor Table into IDTR on the current core.
///
/// # Safety
///
