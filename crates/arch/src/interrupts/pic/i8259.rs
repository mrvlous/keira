...
/// Master PIC Command/Status I/O Port.
pub const PIC1_COMMAND: u16 = 0x20;
/// Master PIC Data/Mask I/O Port.
pub const PIC1_DATA: u16 = 0x21;
/// Slave PIC Command/Status I/O Port.
pub const PIC2_COMMAND: u16 = 0xA0;
/// Slave PIC Data/Mask I/O Port.
...
/// Executes the cascade initialization sequence on the 8259 PIC pair.
///
/// # Arguments
///
/// * `offset1` - IRQ base vector offset for Master PIC (typically 32).
/// * `offset2` - IRQ base vector offset for Slave PIC (typically 40).
...
/// Signals End-of-Interrupt (EOI) command byte to hardware PIC controller.
...
/// Sets mask bit to disable interrupt signal on target IRQ line.
...
/// Clears mask bit to enable interrupt signal on target IRQ line.
