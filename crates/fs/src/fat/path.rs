...
/// Accumulate unicode character parts from an LFN entry into the accumulator.
...
/// Convert accumulated UTF-16 code units into a UTF-8 string buffer.
...
/// Format 8.3 FAT filename to standard lowercase string.
...
/// Validate and convert filename string to 11-byte 8.3 FAT representation.
...
/// Strip leading/trailing slashes and whitespace from path.
...
/// Locate a directory entry by filename in a given directory cluster.
