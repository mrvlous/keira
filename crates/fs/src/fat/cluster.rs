...
/// Read the FAT entry for a cluster to find the next cluster in the chain.
...
/// Free a cluster chain starting at `start_cluster` by zeroing entries in all FAT copies.
